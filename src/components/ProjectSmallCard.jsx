...
const ProjectSmallCard = ({ projects }) => {
  return (
    <div className="w-[45%] h-[220px] group transition-all ease-in duration-200">
      <div className="p-2 bg-slate-100 dark:bg-stone-900 group-hover:bg-slate-200 group-hover:dark:bg-stone-800 w-full h-full rounded-lg transition-all ease-in duration-200 flex flex-col items-start gap-2">
