...
const Experience = () => {
  return (
    <div className="w-full h-[100%] lg:min-h-[553px] flex flex-col items-start gap-2 transition-all ease-in duration-300">
      <div className="w-full flex flex-row items-center justify-start gap-4 mb-6">
        ...
        <span className="w-[60%] hidden lg:block h-[0.5px] dark:bg-slate-50 bg-stone-950"></span>
      </div>
